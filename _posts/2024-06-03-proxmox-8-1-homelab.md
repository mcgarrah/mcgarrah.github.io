...
For about ten (10) years, I had run an VMWare ESXi server that let me play with new technology and host some content and services. I let it go awhile back while I was in graduate school and working but have missed this as an option ever since. So adding a Proxmox server or cluster will let me get some of that back.
