...
This trick let me add some OVA virtual machine archive provided by the [Mininet](https://mininet.org/) project that used VirtualBox originally. The import worked best in VMware Player because it seemed to clean up issues in the OVA file format.
