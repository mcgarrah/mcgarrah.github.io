...
image: /assets/images/og/dell-wyse-3040-debian12.png
layout: post
categories: [technical, hardware]
tags: [dell-wyse-3040, debian, linux, installation, homelab]
excerpt: "Installing Debian 12 on Dell Wyse 3040 thin clients: BIOS setup, Ventoy boot, the GRUB EFI removable media fix for the bad BIOS, and the dw_dmac blacklist that prevents lockups on shutdown."
description: "Step-by-step guide to installing Debian 12 on Dell Wyse 3040 thin clients. Covers BIOS Secure Boot disable, Ventoy USB boot, guided LVM disk setup, the mandatory GRUB force-install-to-EFI-removable-media fix for the Wyse 3040's non-standard UEFI, and the dw_dmac kernel module blacklist required to prevent hangs on reboot and shutdown."
published: true
