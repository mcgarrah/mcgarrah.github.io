...
I wanted to do some work on an undocumented binary file format. The free [HexEdit](https://www.catch22.net/software/hexedit) tool for Windows from [Catch22 Software](https://www.catch22.net/) is a pretty good for mapping data structures to the raw binary/hex data in a file.  It uses the C format struct to format the data structures into a human readable format.  It could use some additional docs on how to use the typedef format but was relatively easy to figure out.
