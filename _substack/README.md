...
The `_substack/` prefix ensures Jekyll ignores this directory during builds — content here is not published on the blog.
...
Each Substack article references multiple blog posts on mcgarrah.org. See `_drafts/DRAFTS.md` for the dependency checklist of which blog posts must be live before each Substack publication.
