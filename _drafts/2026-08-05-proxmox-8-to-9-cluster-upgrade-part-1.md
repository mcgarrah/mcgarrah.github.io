...
description: "Part 1 of a five-part series on upgrading a 6-node Proxmox VE 8 cluster to Proxmox VE 9. Covers pre-flight hardening (dead apt repos, a persistent kernel pin, LXC maintenance) and building a Proxmox Backup Server safety net from scratch — all on aging Dell OptiPlex 990 hardware with no out-of-band management."
date: 2026-08-05
